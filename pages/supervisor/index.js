...
function CandidateReportComponent() {
  ...
  const loadAssessmentData = async (result, candidateInfo) => {
    try {
      ...
      setSelectedAssessment({
        ...
        assessment_name: assessmentName, // This is the key fix - using the actual assessment name
  ...
  const assessmentDisplayName = selectedAssessment.assessment_name || config.name; // Use the stored assessment name
    ...
    <AppLayout background="/images/preassessmentbg.jpg">
      <div style={styles.container}>
        ...
        <div ref={reportRef} style={styles.reportContainer}>
          {/* SECTION 1: COVER PAGE - FIXED to show correct assessment name */}
