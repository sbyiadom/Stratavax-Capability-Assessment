// pages/candidate/dashboard.js - WITH PROMINENT COUNTDOWN FOR NATIONAL SERVICE
...
export default function CandidateDashboard() {
  ...
  async function fetchDashboardData() {
    try {
      ...
      // Select the first non-completed assessment, or the first one
      const firstAvailable = data.assessmentCards?.find(a => a.status !== 'completed') || data.assessmentCards?.[0];
      if (firstAvailable) {
        setSelectedAssessment(firstAvailable);
      }
                  ...
                  <div style={styles.detailSection}>
                    ...
                    <div style={styles.detailStatusRow}>
                      ...
                      {selectedAssessment.isNationalService && (
                        <span style={styles.detailNsBadge}>National Service</span>
                      )}
                      
                      {/* ============================================================
                          PROMINENT EXPIRATION COUNTDOWN - ESPECIALLY FOR NATIONAL SERVICE
                          ============================================================ */}
                      {selectedAssessment.expires_at && (() => {
                        ...
                        if (expiryStatus.status === 'expired') {
                          ...
                          const isNationalService = selectedAssessment.isNationalService || selectedAssessment.typeCode === 'national_service';
                          ...
                          return (
                            <span style={{
                              ...
                              {isNationalService && expiryStatus.days <= 7 && expiryStatus.days > 0 && (
                                <span style={{
                                  background: '#dc2626',
                                  color: 'white',
                                  padding: '2px 8px',
                    ...
                    {/* ============================================================
                        NATIONAL SERVICE DEADLINE NOTICE - PROMINENT DISPLAY
                        ============================================================ */}
                          ...
                          <div style={{
                            ...
                            <div style={{ flex: 1 }}>
                              ...
                              <div style={{
                                ...
                                Deadline: {formatDate(selectedAssessment.expires_at)}
                              </div>
                            </div>
                            {isUrgent && (
                              <button
