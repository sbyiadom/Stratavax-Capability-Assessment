...
// Returns all assessments, joined with their assessment_type for display.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    let listQuery = serviceClient
      .from('assessments')
      .select('id, title, assessment_type_id, description, instructions, is_active, expires_at, created_at, updated_at, assessment_types(id, code, name, question_count, time_limit_minutes)')
