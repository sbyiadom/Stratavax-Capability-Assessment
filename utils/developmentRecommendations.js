...
const defaultRecommendation = (category, percentage) => {
  const value = toNumber(percentage, 0);
  const normalizedCategory = normalizeText(category || "this area", "this area");
...
const recommendations = {
  ...
  "Emotional Intelligence": {
    ...
    strength:
      "Leverage emotional intelligence through team coordination, peer support, coaching opportunities, or stakeholder interaction."
  },

  // ======================================================
  // GENERAL / COGNITIVE / TECHNICAL / CULTURAL
  // ======================================================
